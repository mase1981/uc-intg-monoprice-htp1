...
def create_sensors(config: HTP1Config, device: HTP1Device) -> list[HTP1Sensor]:
    ...
    sensors = [
        ...
        HTP1Sensor(f"sensor.{device_id}.ss_trim", f"{name} Seat Shaker Trim", device, "ss_trim", ""),
        HTP1Sensor(f"sensor.{device_id}.ss_mute", f"{name} Seat Shaker Mute", device, "ss_mute", ""),
        HTP1Sensor(f"sensor.{device_id}.ss_preset", f"{name} Seat Shaker Preset", device, "ss_preset", ""),
